---
title: "Hermes Agent 스킬"
description: "Hermes Agent 스킬을 카테고리별로 정리합니다."
publish: true
draft: false
lang: "ko"
...
- 예를 들어 GitHub 작업은 `github-pr-workflow`, Obsidian 문서 정리는 `obsidian-personal-docs-human-guides`, 버그 조사는 `systematic-debugging`이 기준 절차를 제공합니다.
