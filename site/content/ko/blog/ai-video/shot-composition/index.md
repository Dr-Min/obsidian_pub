---
title: "AI 영상 프롬프트 용어: 화면 구도"
description: "샷 크기, 카메라 각도, 프레이밍을 실제 사진 레퍼런스로 정리한 AI 영상 프롬프트 용어집입니다."
publish: true
draft: false
lang: "ko"
translationKey: "ai-video-shot-composition"
tags:
  - blog
  - ko
  - ai-video
...
이번 페이지는 추상 다이어그램이 아니라 **실제 사진 레퍼런스**로 다시 정리했습니다.  
...
이 페이지에서 중요한 건 용어 정의보다 **프레임 안에서 피사체 비중이 어떻게 바뀌는지**를 눈으로 익히는 것입니다.
