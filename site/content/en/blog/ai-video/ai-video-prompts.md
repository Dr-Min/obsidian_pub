---
title: "How to Write AI Video Prompts: Practical Examples and Structure"
description: "A practical guide to structuring AI video prompts with clear camera language."
publish: true
draft: false
lang: "en"
...
```text
[subject] + [action] + [shot composition] + [lens/depth] + [camera movement] + [lighting] + [environment] + [mood]
```
...
```text
a woman walking through a rainy alley, medium shot, 50mm lens, slow tracking shot, soft neon glow, cinematic realism
```
